...
def get_openai_full_response(prompt: str, system_prompt: str | None = None, api_key: str = OPENAI_API_KEY) -> str:
    # Set the OpenAI API key
    client = OpenAI(api_key=api_key)
    # Create a completion using the chat model
...
def chat_with(chat_id: str, prompt: str, system_prompt: str):
